...
<?php require_once('../admin/includes/class.user.php');
$user = new User();
$user->get_session();
$uid = $user->get_uid();
...
/*response: Your account has been successfully created, 
	you will be redirected to your account in <p id="count">10 seconds...</p>
	if you do not wish to wait <a id="here" href="home.php" >here</a>
