...
?>
	...
	<body>
		<nav class="navbar navbar-default navbar-fixed-top">
		  <div class="container">
				<a class="navbar-left" href="file:///C|/xampp/htdocs/home.php">Home</a>
				<?php
				...
				?>
				<a class="navbar-right" href="file:///C|/xampp/htdocs/home.php?q=logout">LOGOUT</a>
		  </div>
		</nav>
		...
		<div class="d-flex background-nav2">
			...
			<div class="p-2 nav2">|<a href="../../../../../admin/navbar/admin/navbar/library/library-php/library.php">Library</a></div>
			<div class="p-2 nav2">|<a href="">My Recommendations</a></div>
			<div class="p-2 nav2">|<a href="../../../../../admin/navbar/admin/navbar/settings/settings.php">Settings</a></div>
		...
		<div class="d-flex all">
			<div class="mr-auto p-2">
				...
				<a class="active" href="currently-watching.php">Series</a>
				<a class="grey" href="../anime/anime.php">Anime</a>
			</div>
		</div>
		...
		<div class="container">
					<nav class="greycolor">
						<ul>
                        <a href="all.php" class="">All Movies</a>
						<a href="currently-watching.php" class="">Currently Watching</a>
						<a href="completed.php" class="active2">Completed</a>
						<a href="onhold.php" class="">On Hold</a>
						<a href="dropped.php" class="">Dropped</a>
						<a href="plan-to-watch.php" class="">Plan to Watch</a>
				...
				<table id="maltest">
					...
					<tr>
						...
						<td><img src="../images/sword-art-online.jpg" height=70px width=50px></td>
								  <td><span class="left">Sword Art Online</span><span class="right"><a href="../../../../../admin/navbar/more.php">More</a> - <a herf="edit.php">edit</a></span></td>
						<td>Serie</td>
						<td>9.2</td>
					...
					<tr>
						...
						<td><img src="../images/spider-man.jpg" height=70px width=50px></td>
								  <td><span class="left">Spider-man</span><span class="right"><a href="../../../../../admin/navbar/more.php">More</a> - <a herf="edit.php">edit</a></span></td>
						<td>Movie</td>
						<td>6.8</td>
					...
					<tr>
						...
						<td><img src="../images/ncis.jpg" height=70px width=50px></td>
								  <td><span class="left">NCIS</span><span class="right"><a href="../../../../../admin/navbar/more.php">More</a> - <a herf="edit.php">edit</a></span></td>
						<td>Serie</td>
						<td>7.7</td>
						<td>- / xx <i class="fa fa-plus-circle blue"></i></td>
						<td>
					...
					<tr>
						...
						<td><img src="../images/batman.jpg" height=70px width=50px></td>
								  <td><span class="left">Batman</span><span class="right"><a href="../../../../../admin/navbar/more.php">More</a> - <a herf="edit.php">edit</a></span></td>
						<td>Movie</td>
						<td>6.2</td>
						<td>- / xx <i class="fa fa-plus-circle blue"></i></td>
						<td>
...
<script src="../../../../../admin/navbar/assets/library.js"></script>
