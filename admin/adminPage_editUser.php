...
<head>
    ...
    <link rel="stylesheet" href="../assets-system/css/bootstrap.css"/>
		...
		<link rel="stylesheet" href="../assets-system/css/multiselect.css"/>
		<script src="../assets-system/js/jquery.js"></script>
		<script src="../assets-system/js/multiselect.min.js"></script>
</head>
<body>
	...
	<!-- SweetAlert -->
  <script src="../assets-system/js/sweetalert.min.js"></script>
  <link rel="stylesheet" href="../assets-system/css/sweetalert.min.css">
	<script>
	...
	<ul id="social_side_links">
		<li><a style="background-color: #e81010" onclick="deleteUser()" title="Delete User"><img src="../assets-system/images/user-delete.svg" /></a></li>
	</ul>
